...
export function Button({ title, onPress, variant = "primary", disabled, loading, testID, style, icon: Icon }) {
  ...
  const border = variant === "outline" ? { borderWidth: 1, borderColor: colors.warmBorder } : {};
...
const styles = StyleSheet.create({
  ...
  dimensional: { shadowColor: "#000000", shadowOpacity: .12, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 2 },
