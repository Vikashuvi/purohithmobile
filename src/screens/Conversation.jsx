...
const styles = StyleSheet.create({
  ...
  bubble: { maxWidth: "82%", paddingHorizontal: 14, paddingVertical: 11, borderRadius: 18 }, mine: { alignSelf: "flex-end", backgroundColor: colors.ink, borderBottomRightRadius: 5 }, theirs: { alignSelf: "flex-start", backgroundColor: colors.muted, borderBottomLeftRadius: 5 },
  ...
  composer: { flexDirection: "row", alignItems: "flex-end", gap: 8, padding: spacing.md, paddingHorizontal: spacing.lg, backgroundColor: colors.white, borderTopWidth: 1, borderColor: colors.warmBorder }, input: { flex: 1, minHeight: 46, maxHeight: 100, backgroundColor: colors.muted, borderRadius: 23, paddingHorizontal: 16, paddingVertical: 12, color: colors.ink, fontSize: font.sizes.base }, send: { width: 46, height: 46, borderRadius: 23, backgroundColor: colors.ink, alignItems: "center", justifyContent: "center" },
});
